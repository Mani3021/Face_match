...
def orb_sim(img1, img2):
  #form opencv we creating  an object orb
  orb = cv2.ORB_create()

  # detect keypoints and descriptors/ key points and descriptor 
  ...
  # 0 is perfect match and 100 is not simliar 
...
img00 = cv2.imread('images/manish1.jpg', 0)
img01 = cv2.imread('images/manish2.jpg', 0)
